...
#define SHARP_HW_REV_BIT3	0x0004
#define SHARP_HW_REV_BIT2	0x0002
#define SHARP_HW_REV_BIT1	0x0001
			...
			struct qpnp_adc_drv *adc_qpnp)
{
	...
	if(p_smem) {
		...
		pr_err("sh_smem_get_common_address failed\n");
	}
#endif /* CONFIG_BATTERY_SHARP */
...
#ifdef CONFIG_BATTERY_SHARP
			if (strcmp(channel_name, "bat_therm") == 0)
			{
				if (p_smem->sh_hw_revision & SHARP_HW_REV_BIT3) {
					hw_settle_time = 0;
				}
			}
#endif /* CONFIG_BATTERY_SHARP */
