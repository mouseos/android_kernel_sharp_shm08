...
extern int snd_sdm450_proxy_msm_headset_hp_state(void);
extern int snd_sdm450_proxy_msm_headset_bu_state(void);
extern int snd_sdm450_proxy_diag_codec_set_bias_mode(int mode);
#endif /* CONFIG_SH_AUDIO_DRIVER */ /* A-006 */
#ifdef CONFIG_SH_AUDIO_DRIVER /* B-003 */
extern int snd_sdm450_proxy_msm_set_a2dp_mode(int mode);
extern int snd_sdm450_proxy_msm_get_is_music_play(void);
