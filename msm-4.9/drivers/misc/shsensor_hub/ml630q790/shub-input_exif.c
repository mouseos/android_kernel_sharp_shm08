...
#include <linux/input/touchevent_notifier.h>      /* SHMDS_HUB_3702_01 mod */
#include <linux/qpnp/qpnp-haptic.h>     /* SHMDS_HUB_3702_01 add */
//#include <sharp/sh_audio_sdm450.h>      /* SHMDS_HUB_3702_01 SHMDS_HUB_3702_02 del */
#endif
...
#else
int shub_api_audio_pedometer_func(unsigned int on)
{
    if(on == 1){
        shub_api_stop_pedometer_func(SHUB_STOP_PED_TYPE_SPE);
    }else{
...
EXPORT_SYMBOL(shub_api_audio_pedometer_func);
#endif
/* SHMDS_HUB_3702_02 mod E */
#endif
/* SHMDS_HUB_3702_01 mod E */
...
/* SHMDS_HUB_3702_01 mod S */
#ifdef SHUB_SW_NOTIFIER
    ret = touchevent_register_client(&shub_touchpanel_pedometer_handler);
    if (ret) {
...
/* SHMDS_HUB_3702_02 del S */
//  ret = register_shub_api_speaker_notifier(&shub_audio_pedometer_handler);
//  if (ret) {
//      printk("%s: audio notifier register failed\n", __func__);
//      goto out_driver;
//  }
/* SHMDS_HUB_3702_02 del E */
#endif
/* SHMDS_HUB_3702_01 mod E */
...
/* SHMDS_HUB_3702_01 mod S */
#ifdef SHUB_SW_NOTIFIER
    touchevent_unregister_client(&shub_touchpanel_pedometer_handler);

    qpnp_hap_unregister_notifier(&shub_vibration_pedometer_handler);

//  unregister_shub_api_speaker_notifier(&shub_audio_pedometer_handler);  /* SHMDS_HUB_3702_02 del */
#endif
/* SHMDS_HUB_3702_01 mod E */
