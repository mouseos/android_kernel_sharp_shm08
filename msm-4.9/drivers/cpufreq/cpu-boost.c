...
#ifdef CONFIG_SHARP_PNP_CLOCK
static int sh_disp_status_callback(struct notifier_block *self, unsigned long event, void *data)
{
...
static struct notifier_block sh_disp_status_fb_notif = {
	.notifier_call = sh_disp_status_callback,
};
#endif /* CONFIG_SHARP_PNP_CLOCK */
...
#ifdef CONFIG_SHARP_PNP_CLOCK
	fb_register_client(&sh_disp_status_fb_notif);
#endif /* CONFIG_SHARP_PNP_CLOCK */
